		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"kfcurl_request.example", "response",
						`{"name": "devopsrob"}`),
					resource.TestCheckResourceAttr(
						"kfcurl_request.example", "url",
						"https://example.com"),
					resource.TestCheckResourceAttr(
						"kfcurl_request.example", "name",
						"leader"),
					resource.TestCheckResourceAttr(
						"kfcurl_request.example", "method",
						"GET"),
					resource.TestCheckResourceAttr(
						"kfcurl_request.example", "destroy_url",
						"https://example.com"),
					resource.TestCheckResourceAttr(
						"kfcurl_request.example", "destroy_method",
						"GET"),
				),
			},
		},
...
resource "kfcurl_request" "example" {
  name           = "leader"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						...
						"POST"),
					resource.TestCheckResourceAttr(
						"kfcurl_request.example", "response_codes.#", "1"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						...
						"POST"),
					resource.TestCheckResourceAttr(
						"kfcurl_request.example", "request_url_string",
